...
func (x *NumberArray) GetData() []float64 {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *SumOfNumberArray) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SumOfNumberArray) ProtoMessage() {}

func (x *SumOfNumberArray) ProtoReflect() protoreflect.Message {
	mi := &file_app_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SumOfNumberArray.ProtoReflect.Descriptor instead.
func (*SumOfNumberArray) Descriptor() ([]byte, []int) {
	return file_app_proto_rawDescGZIP(), []int{1}
}

func (x *SumOfNumberArray) GetSum() float64 {
	if x != nil {
		return x.Sum
	}
	return 0
...
var file_app_proto_rawDesc = []byte{
	...
	,
}
...
var file_app_proto_goTypes = []interface{}{
	(*NumberArray)(nil),      // 0: app.NumberArray
	(*SumOfNumberArray)(nil), // 1: app.SumOfNumberArray
}
var file_app_proto_depIdxs = []int32{
	0, // 0: app.AppController.Accumulate:input_type -> app.NumberArray
	1, // 1: app.AppController.Accumulate:output_type -> app.SumOfNumberArray
